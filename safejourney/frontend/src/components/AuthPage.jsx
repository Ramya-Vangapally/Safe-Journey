...
const AuthPage = ({ setIsAuthenticated }) => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden" style={{
      ...
      {/* Splash Screen - SAFE PATH AI */}
      {showSplash && (
        <div className="fixed inset-0 flex items-center justify-center z-50 animate-[fadeInUp_0.6s_ease-out_forwards]">
          <div className="text-center">
            <h1 className="text-6xl font-bold text-white mb-4 animate-[fadeInUp_0.8s_ease-out_forwards]">SAFE PATH AI</h1>
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-white mb-2">SAFE PATH AI</h1>
